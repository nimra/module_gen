...
class Content(LeafNode):
    def __init__(self):
        super().__init__(
            "Part VII: Advanced Analytics/Machine Learning on Google Cloud Platform",
        ...
        self.add(mbk("# Part VII: Advanced Analytics/Machine Learning on Google Cloud Platform"))
