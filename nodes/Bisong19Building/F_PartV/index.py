...
from .A_Chapter27.index import Chapter27 as A_Chapter27
from .B_Chapter28.index import Chapter28 as B_Chapter28
from .C_Chapter29.index import Chapter29 as C_Chapter29
...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Part V: Introducing Deep Learning"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class PartV(HierNode):
    def __init__(self):
        super().__init__("Part V: Introducing Deep Learning")
        self.add(Content())
        self.add(A_Chapter27())
        self.add(B_Chapter28())
        self.add(C_Chapter29())
