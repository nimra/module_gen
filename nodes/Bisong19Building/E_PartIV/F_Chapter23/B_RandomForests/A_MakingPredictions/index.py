...
blocks = [
    ...
    ibk("Figure 23-3. Take a majority vote to determine the final class in the classification case and the average of the values in each tree to determine the predicted value in the regression case"),
]
