...
blocks = [
    ...
    ibk(None, "Figure 19-2. Scatter plot of x1 (on the x axis) and y (on the y axis)"),
    ...
    ibk(None, "Figure 19-3. Scatter plot of x1 (on the x axis) and y (on the y axis) with regression line"),
]
