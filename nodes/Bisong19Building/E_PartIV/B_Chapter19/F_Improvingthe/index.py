...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
blocks = [
    mbk("The following techniques are options that can be explored to improve the performance of a linear regression model."),
    mbk("""
...
- A standard practice, in this case, is to apply regularization (more on this in Chapter 21) to the regression model. This can do a good job at preventing overfitting.
    """),
    mbk("This chapter provides an overview on the linear regression machine learning algorithm for learning real-valued targets. Also, the chapter provided practical steps for implementing linear regression models with Scikit-learn. In the next chapter, we will examine logistic regression for learning classification problems."),
]
...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(mbk("# Improving the Performance of a Linear Regression Model"))
