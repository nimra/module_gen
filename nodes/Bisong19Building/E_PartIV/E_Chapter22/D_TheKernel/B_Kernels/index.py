...
blocks = [
    ...
    HierBlock("Radial Basis Function or the Radial Kernel", [
        ...
        ibk("Figure 22-11. An illustration of adjusting the radial basis function γ parameter, together with the C parameter of the support vector classifier to fit a non-linear decision boundary. Left: RBF kernel with C = 1 and γ = 10−3. Right: RBF kernel with C = 1 and γ = 10−5."),
