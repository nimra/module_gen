...
from .A_LearnableRepresentations.index import LearnableRepresentations as A_LearnableRepresentations
from .B_Activations.index import Activations as B_Activations
from .C_FullyConnected.index import FullyConnected as C_FullyConnected
from .D_Regularization.index import Regularization as D_Regularization
from .E_TrainingFully.index import TrainingFully as E_TrainingFully
...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Training Fully Connected Neural Networks"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class TrainingFully(HierNode):
    def __init__(self):
        super().__init__("Training Fully Connected Neural Networks")
        self.add(Content())
        self.add(A_LearnableRepresentations())
        self.add(B_Activations())
        self.add(C_FullyConnected())
        self.add(D_Regularization())
        self.add(E_TrainingFully())
