...
from .A_InstallingDeepChem.index import InstallingDeepChem as A_InstallingDeepChem
from .B_Tox21Dataset.index import Tox21Dataset as B_Tox21Dataset
from .C_AcceptingMinibatches.index import AcceptingMinibatches as C_AcceptingMinibatches
from .D_Implementinga.index import Implementinga as D_Implementinga
from .E_AddingDropout.index import AddingDropout as E_AddingDropout
from .F_ImplementingMinibatching.index import ImplementingMinibatching as F_ImplementingMinibatching
from .G_EvaluatingModel.index import EvaluatingModel as G_EvaluatingModel
from .H_UsingTensorBoard.index import UsingTensorBoard as H_UsingTensorBoard
...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Implementation in TensorFlow"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class Implementationin(HierNode):
    def __init__(self):
        super().__init__("Implementation in TensorFlow")
        self.add(Content())
        self.add(A_InstallingDeepChem())
        self.add(B_Tox21Dataset())
        self.add(C_AcceptingMinibatches())
        self.add(D_Implementinga())
        self.add(E_AddingDropout())
        self.add(F_ImplementingMinibatching())
        self.add(G_EvaluatingModel())
        self.add(H_UsingTensorBoard())
