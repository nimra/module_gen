...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Using TensorBoard to Track Model Convergence"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class UsingTensorBoard(HierNode):
    def __init__(self):
        super().__init__("Using TensorBoard to Track Model Convergence")
        self.add(Content())
