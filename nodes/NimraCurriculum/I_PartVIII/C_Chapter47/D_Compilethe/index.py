...
class Content(LeafNode):
    def __init__(self):
        super().__init__("Compile the Pipeline Using the Kubeflow Pipelines DSL Language")
        self.add(MarkdownBlock("# Compile the Pipeline Using the Kubeflow Pipelines DSL Language"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class Compilethe(HierNode):
    def __init__(self):
        super().__init__("Compile the Pipeline Using the Kubeflow Pipelines DSL Language")
        self.add(Content())
