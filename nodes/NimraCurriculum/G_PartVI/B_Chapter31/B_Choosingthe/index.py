...
class Content(LeafNode):
    def __init__(self):
        super().__init__("Choosing the Number of Hidden Layers: Bias/Variance Trade-Off")
        self.add(MarkdownBlock("# Choosing the Number of Hidden Layers: Bias/Variance Trade-Off"))
