...
from .A_MemoryCells.index import MemoryCells as A_MemoryCells
from .B_Inputand.index import Inputand as B_Inputand
...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Recurrent Neurons"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class RecurrentNeurons(HierNode):
    def __init__(self):
        super().__init__("Recurrent Neurons")
        self.add(Content())
        self.add(A_MemoryCells())
        self.add(B_Inputand())
