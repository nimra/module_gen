...
from .B_TyingWeights.index import TyingWeights as B_TyingWeights
from .C_TrainingOne.index import TrainingOne as C_TrainingOne
from .D_Visualizingthe.index import Visualizingthe as D_Visualizingthe
from .E_VisualizingFeatures.index import VisualizingFeatures as E_VisualizingFeatures
...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Stacked Autoencoders"))
...
class StackedAutoencoders(HierNode):
    def __init__(self):
        ...
        self.add(B_TyingWeights())
        self.add(C_TrainingOne())
        self.add(D_Visualizingthe())
        self.add(E_VisualizingFeatures())
