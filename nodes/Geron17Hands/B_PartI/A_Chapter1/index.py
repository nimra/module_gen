...
from .B_WhyUse.index import WhyUse as B_WhyUse
from .C_Typesof.index import Typesof as C_Typesof
from .D_MainChallenges.index import MainChallenges as D_MainChallenges
from .E_Testingand.index import Testingand as E_Testingand
...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Chapter 1. The Machine Learning Landscape"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class Chapter1(HierNode):
    def __init__(self):
        super().__init__("Chapter 1. The Machine Learning Landscape")
        self.add(Content())
        self.add(A_WhatIs())
        self.add(B_WhyUse())
        self.add(C_Typesof())
        self.add(D_MainChallenges())
        self.add(E_Testingand())
