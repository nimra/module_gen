...
from .C_EnsembleMethods.index import EnsembleMethods as C_EnsembleMethods
from .D_Analyzethe.index import Analyzethe as D_Analyzethe
from .E_EvaluateYour.index import EvaluateYour as E_EvaluateYour
...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Fine-Tune Your Model"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class FineTuneYour(HierNode):
    def __init__(self):
        super().__init__("Fine-Tune Your Model")
        self.add(Content())
        self.add(A_GridSearch())
        self.add(B_RandomizedSearch())
        self.add(C_EnsembleMethods())
        self.add(D_Analyzethe())
        self.add(E_EvaluateYour())
