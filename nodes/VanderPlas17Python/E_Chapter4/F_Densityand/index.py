...
from .A_Visualizinga.index import Visualizinga as A_Visualizinga
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class Densityand(HierNode):
    def __init__(self):
        super().__init__("Density and Contour Plots")
        self.add(Content())
        self.add(A_Visualizinga())
