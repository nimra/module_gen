...
from .A_pltaxesSubplots.index import pltaxesSubplots as A_pltaxesSubplots
from .B_pltsubplotSimple.index import pltsubplotSimple as B_pltsubplotSimple
from .C_pltsubplotsThe.index import pltsubplotsThe as C_pltsubplotsThe
from .D_pltGridSpecMore.index import pltGridSpecMore as D_pltGridSpecMore
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class MultipleSubplots(HierNode):
    def __init__(self):
        super().__init__("Multiple Subplots")
        self.add(Content())
        self.add(A_pltaxesSubplots())
        self.add(B_pltsubplotSimple())
        self.add(C_pltsubplotsThe())
        self.add(D_pltGridSpecMore())
