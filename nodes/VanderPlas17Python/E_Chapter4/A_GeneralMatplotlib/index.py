...
from .A_Importingmatplotlib.index import Importingmatplotlib as A_Importingmatplotlib
from .B_SettingStyles.index import SettingStyles as B_SettingStyles
from .C_showor.index import showor as C_showor
from .D_SavingFigures.index import SavingFigures as D_SavingFigures
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class GeneralMatplotlib(HierNode):
    def __init__(self):
        super().__init__("General Matplotlib Tips")
        self.add(Content())
        self.add(A_Importingmatplotlib())
        self.add(B_SettingStyles())
        self.add(C_showor())
        self.add(D_SavingFigures())
