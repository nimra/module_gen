...
from .A_DataSelection.index import DataSelection as A_DataSelection
from .B_DataSelection.index import DataSelection as B_DataSelection
...
class DataIndexing(HierNode):
    def __init__(self):
        super().__init__("Data Indexing and Selection")
        self.add(Content())
        self.add(A_DataSelection())
        self.add(B_DataSelection())
