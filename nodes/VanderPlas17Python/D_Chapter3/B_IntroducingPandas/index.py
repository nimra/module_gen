...
from .A_ThePandas.index import ThePandas as A_ThePandas
from .B_ThePandas.index import ThePandas as B_ThePandas
from .C_ThePandas.index import ThePandas as C_ThePandas
...
class IntroducingPandas(HierNode):
    def __init__(self):
        super().__init__("Introducing Pandas Objects")
        self.add(Content())
        self.add(A_ThePandas())
        self.add(B_ThePandas())
        self.add(C_ThePandas())
