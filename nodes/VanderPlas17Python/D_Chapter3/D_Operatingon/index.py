...
from .A_UfuncsIndex.index import UfuncsIndex as A_UfuncsIndex
from .B_UFuncsIndex.index import UFuncsIndex as B_UFuncsIndex
from .C_UfuncsOperations.index import UfuncsOperations as C_UfuncsOperations
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class Operatingon(HierNode):
    def __init__(self):
        super().__init__("Operating on Data in Pandas")
        self.add(Content())
        self.add(A_UfuncsIndex())
        self.add(B_UFuncsIndex())
        self.add(C_UfuncsOperations())
