...
from .A_MotivatingPivot.index import MotivatingPivot as A_MotivatingPivot
from .B_PivotTables.index import PivotTables as B_PivotTables
from .C_PivotTable.index import PivotTable as C_PivotTable
from .D_ExampleBirthrate.index import ExampleBirthrate as D_ExampleBirthrate
...
class PivotTables(HierNode):
    def __init__(self):
        super().__init__("Pivot Tables")
        self.add(Content())
        self.add(A_MotivatingPivot())
        self.add(B_PivotTables())
        self.add(C_PivotTable())
        self.add(D_ExampleBirthrate())
