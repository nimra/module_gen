...
from .A_IPythonsIn.index import IPythonsIn as A_IPythonsIn
from .B_UnderscoreShortcuts.index import UnderscoreShortcuts as B_UnderscoreShortcuts
from .C_SuppressingOutput.index import SuppressingOutput as C_SuppressingOutput
from .D_RelatedMagic.index import RelatedMagic as D_RelatedMagic
...
class Inputand(HierNode):
    def __init__(self):
        super().__init__("Input and Output History")
        self.add(Content())
        self.add(A_IPythonsIn())
        self.add(B_UnderscoreShortcuts())
        self.add(C_SuppressingOutput())
        self.add(D_RelatedMagic())
