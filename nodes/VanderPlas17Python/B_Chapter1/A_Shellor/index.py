...
from .A_Launchingthe.index import Launchingthe as A_Launchingthe
from .B_Launchingthe.index import Launchingthe as B_Launchingthe
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class Shellor(HierNode):
    def __init__(self):
        super().__init__("Shell or Notebook?")
        self.add(Content())
        self.add(A_Launchingthe())
        self.add(B_Launchingthe())
