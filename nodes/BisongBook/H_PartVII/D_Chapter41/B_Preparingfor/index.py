...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Preparing for Training and Serving on Cloud MLE"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class Preparingfor(HierNode):
    def __init__(self):
        super().__init__("Preparing for Training and Serving on Cloud MLE")
        self.add(Content())
