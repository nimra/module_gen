...
class Content(LeafNode):
    def __init__(self):
        ...
        self.add(MarkdownBlock("# Packaging the Code for Training on Cloud MLE"))

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class Packagingthe(HierNode):
    def __init__(self):
        super().__init__("Packaging the Code for Training on Cloud MLE")
        self.add(Content())
