...
from .A_CrossValidationin.index import CrossValidationin as A_CrossValidationin
from .B_Benefitsof.index import Benefitsof as B_Benefitsof
from .C_StratifiedkFold.index import StratifiedkFold as C_StratifiedkFold
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class CrossValidation(HierNode):
    def __init__(self):
        super().__init__("Cross-Validation")
        self.add(Content(), "content")
        self.add(A_CrossValidationin())
        self.add(B_Benefitsof())
        self.add(C_StratifiedkFold())
